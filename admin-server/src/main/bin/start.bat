...
set APP_NAME=admin-server.jar
set CONFIG= -Dlogging.path=../logs -Dspring.config.location=../config/logback-spring.xml -Dspring.config.location=$CONF_DIR/application.yml
